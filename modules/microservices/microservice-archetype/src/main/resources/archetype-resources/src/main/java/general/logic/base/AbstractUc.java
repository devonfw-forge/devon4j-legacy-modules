...
import ${package}.general.logic.api.AbstractBeanMapperSupport;
 ...
 * {@link javax.inject.Named} and UseCase.
 *
 */
public abstract class AbstractUc extends AbstractBeanMapperSupport {
   ...
   * {@link GenericEntity${symbol_pound}getId() ID} as key. All {@link GenericEntity entities} without an {@link GenericEntity${symbol_pound}getId()
