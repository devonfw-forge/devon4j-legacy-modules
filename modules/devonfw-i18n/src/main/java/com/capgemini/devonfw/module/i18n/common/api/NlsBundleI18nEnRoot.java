...
public interface NlsBundleI18nEnRoot extends NlsBundle {
   ...
   * @return
   */
  @NlsBundleMessage("UnknownLocaleException: This locale {locale} is not present.")
  public NlsMessage UnknownLocaleException(@Named("locale") String locale);
